...
page_designer_agent = Agent(
    ...
    output_key="page_designer_agent_output"
)


# ADK web expects root_agent (needed when used as sub-agent in SequentialAgent)
root_agent = page_designer_agent
